...
(+prompt('Введіть, будь ласка, рік!') % 4 ===0)? console.log("Високосний"): console.log("Невисокосний");

// 7. Використовуючи конструкцію if..else, напишіть код, який запитуватиме: „Яка «офіційна» назва JavaScript?“


// 8. Якщо користувач вводить «ECMAScript», то показати: «Правильно!», інакше – відобразити: «Не знаєте? ECMAScript!
